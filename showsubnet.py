...
if __name__ == '__main__':
    ...
    parser.add_argument( '-ad', '--address', dest = 'ad', default = '', help = 'The address of all plots generated from multi-component system anlysis. If not specified, edges of subnetworks will not direct to corresponding hydropathy plots.' )
    parser.add_argument( '-l', '--list', dest = 'list', required = True, help = 'Mandatory. list of TC system or protein candidates in the genome seperated by comma in a string. eg ."1.A.30.2.1,1.A.30.2.5,dmul_13829"' )
